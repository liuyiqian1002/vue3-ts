...
let mainData = reactive({
    ...
    foldNumber: 3,
    columns: [
        { prop: 'title', label: '抄送标题' },
        { prop: 'digest', label: '摘要' },
        { prop: 'noticeType', label: '抄送类型', filter: 'copyNoticeType'},
    ...
    lists: [
        { label: '抄送标题', key: 'title', placeholder: '请输入' },
        { label: '抄送类型', key: 'noticeType', type:'select', filter: 'copyNoticeType'},
