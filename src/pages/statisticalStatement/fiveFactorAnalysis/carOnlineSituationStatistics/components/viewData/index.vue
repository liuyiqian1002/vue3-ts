...
import {exportVehicleList} from "@/api/statisticalStatement/fiveFactorAnalysis/carOnlineSituationStatistics";
...
let mainData = reactive({
    ...
    columns: [
        ...
        { prop: 'beginDateStr', label: '开始时间', color: '#FF0000' },
        { prop: 'endDateStr', label: '结束时间', color: '#FF0000' },
    ],
    //
})
