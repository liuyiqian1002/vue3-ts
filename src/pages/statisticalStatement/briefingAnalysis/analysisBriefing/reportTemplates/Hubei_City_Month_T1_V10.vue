    ...
    part2Data.carDangerAlarmNumberTop3Value }}</i>。
      ...
      <div class="table-wrapper">
        <table class="table" border="1">
          ...
          <tr>
            <td colspan="2">小计</td>
            <td>{{ part2Data.allVehicleAlarmRankingInfosSum.vehilceNumber }}</td>
      ...
      <div v-if="part2Data.importantVehicleAlarmRankingInfos.length > 0">
        ...
        <div class="table-wrapper">
          <table class="table" border="1">
            ...
            <tr>
              <td colspan="2">小计</td>
              <td>{{ part2Data.importantVehicleAlarmRankingInfosSum.vehilceNumber }}</td>
      ...
      <p class="text-wrapper">
        ...
        <span v-if="part2Data.dangerAlarmInfos.length > 0">
          ...
          {{ part2Data.dangerAlarmNumberTop3Seperator }}
        </span>
        <span v-if="part2Data.goodsAlarmInfos.length > 0">
          普货（总质量12吨）违规车辆报警均值辖区排名{{ part2Data.goodsAlarmNumberTop3Prefix }}为：<i class="red">{{
            part2Data.goodsAlarmNumberTop3District }}</i>，分别为：<i class="red">{{ part2Data.goodsAlarmNumberTop3Value
  }}</i>。
        </span>
      </p>
      ...
      <p class="text-wrapper">
        ...
        <span v-if="part3Data.dangerCompanyAlarmRankingInfos.length > 0">
          ...
          {{ part3Data.dangerAlarmNumberTop3Seperator }}
        </span>
        <span v-if="part3Data.goodsCompanyAlarmRankingInfos.length > 0">
          普货（总质量12吨）违规车辆报警均值{{ part3Data.goodsAlarmNumberTop3Prefix }}企业为：<i class="red">{{
            part3Data.goodsAlarmNumberTop3Company }}</i>
          ，分别为{{ part3Data.goodsAlarmNumberTop3Value }}。
        </span>
      </p>
      ...
      <div class="img-wrapper text-center">
        ...
        <table class="img-table" border="1" id="part5Chart1TableId"
          :refTest="`${part5Chart1TableBus},${part5Chart1TableTour},${part5Chart1TableDanger},${part5Chart1TableGoods}`">
          <tr>
            <th></th>
            ...
            <!-- </c:if> -->
            <!-- <c:if v-if="!part5Chart1TableGoods" -->
            <th v-if="!part5Chart1TableGoods">普通货运</th>
            <!-- </c:if> -->
            <th>合计</th>
          </tr>
          <tr>
            ...
            <!-- </c:if> -->
            <!-- <c:if v-if="!part5Chart1TableGoods" -->
            <th v-if="!part5Chart1TableGoods">{{ part5Data.allAlarmTendencyInfo.lastMonth.goodsAlarmNumber }}</th>
            <!-- </c:if> -->
          ...
          <tr>
            ...
            <!-- </c:if> -->
            <!-- <c:if v-if="!part5Chart1TableGoods" -->
            <th v-if="!part5Chart1TableGoods">{{ part5Data.allAlarmTendencyInfo.thisMonth.goodsAlarmNumber }}</th>
            <!-- </c:if> -->
      ...
      <div class="img-wrapper text-center">
        ...
        <table class="img-table" border="1" id="part5Chart2TableId"
          :refTest="`${part5Chart2TableBus},${part5Chart2TableTour},${part5Chart2TableDanger},${part5Chart2TableGoods}`">
          <tr>
            <th></th>
            ...
            <!-- </c:if> -->
            <!-- <c:if v-if="!part5Chart2TableGoods" -->
            <th v-if="!part5Chart2TableGoods">普通货运</th>
            <!-- </c:if> -->
            <th>合计</th>
          </tr>
          <tr>
            ...
            <!-- </c:if> -->
            <!-- <c:if v-if="!part5Chart2TableGoods" -->
            <th v-if="!part5Chart2TableGoods">{{ part5Data.speedingAlarmTendencyInfo.lastMonth.goodsAlarmNumber }}</th>
            <!-- </c:if> -->
          ...
          <tr>
            ...
            <!-- </c:if> -->
            <!-- <c:if v-if="!part5Chart2TableGoods" -->
            <th v-if="!part5Chart2TableGoods">{{ part5Data.speedingAlarmTendencyInfo.thisMonth.goodsAlarmNumber }}</th>
            <!-- </c:if> -->
      ...
      <div class="img-wrapper text-center">
        ...
        <table class="img-table" border="1" id="part5Chart3TableId"
          :refTest="`${part5Chart3TableBus},${part5Chart3TableTour},${part5Chart3TableDanger},${part5Chart3TableGoods}`">
          <tr>
            <th></th>
            ...
            <!-- </c:if> -->
            <!-- <c:if v-if="!part5Chart3TableGoods" -->
            <th v-if="!part5Chart3TableGoods">普通货运</th>
            <!-- </c:if> -->
            <th>合计</th>
          </tr>
          <tr>
            ...
            <!-- </c:if> -->
            <!-- <c:if v-if="!part5Chart3TableGoods" -->
            <th v-if="!part5Chart3TableGoods">{{ part5Data.fatigueAlarmTendencyInfo.lastMonth.goodsAlarmNumber }}</th>
            <!-- </c:if> -->
          ...
          <tr>
            ...
            <!-- </c:if> -->
            <!-- <c:if v-if="!part5Chart3TableGoods" -->
            <th v-if="!part5Chart3TableGoods">{{ part5Data.fatigueAlarmTendencyInfo.thisMonth.goodsAlarmNumber }}</th>
            <!-- </c:if> -->
      ...
      <c:set var="part5Chart4TableTour"
        ...
        <table class="img-table" border="1" id="part5Chart4TableId"
          :refTest="`${part5Chart4TableBus},${part5Chart4TableTour}`">
          <tr>
            <th></th>
      ...
      <div v-if="part6Data.areaOtherAlarmInfos.length > 0 || part6Data.companyOtherAlarmInfos.length > 0">
        ...
        <div class="table-wrapper">
          <table class="table" border="1">
            ...
            <tr>
              <td colspan="2">小计</td>
              <td>{{ part6Data.areaOtherAlarmInfosSum.vehilceNumber }}</td>
