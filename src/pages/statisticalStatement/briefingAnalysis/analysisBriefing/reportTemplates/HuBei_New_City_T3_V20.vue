  ...
  <div>
    ...
    <div class="fullpage">
      ...
      <div>
        ...
        <div
          v-if="vehicleAlarmTypeInfo?.goodsVehicleAlarmTypeInfo?.length > 0"
      ...
      <div>
        <!-- <c:if -->
        <div
          v-if="vehicleAlarmInfo?.goodsVehicleAlarmInfo?.length > 0"
      ...
      <div>
        <!-- <c:if -->
        <div
          v-if="vehicleAlarmCountInfo?.goodsVehicleAlarmCountInfo?.length > 0"
      ...
      <div>
        ...
        <div
          v-if="vehicleAvgAlarmInfo?.goodsVehicleAvgAlarmInfo?.length > 0"
    ...
    <div class="fullpage">
      ...
      <div>
        ...
        <div
          v-if="companyAlarmInfo?.goodsVehicleAvgAlarmInfo?.length > 0"
      ...
      <div>
        ...
        <div
          v-if="vehicleAlarmDetailInfo?.goodsVehicleAlarmInfo?.length > 0"
