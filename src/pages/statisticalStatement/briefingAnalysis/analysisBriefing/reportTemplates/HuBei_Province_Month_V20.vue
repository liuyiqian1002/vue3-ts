<template>
    <div>
        <div class="fullpage">
            <div class="brief">{{ data.provinceReportName }}简报&nbsp;&nbsp;
                <!-- <shiro:hasPermission name="statistics-report-download"> -->
                <a href="javascript:" id="downloadDoc" @click="$event => download()">下载word</a>
                <!-- </shiro:hasPermission> -->
            </div>
        ...
        <div class="fullpage">
            ...
            <!-- 第三方监测平台车辆报警类型分析 -->
            <div v-if="listAlarmTypeAnalysis.length > 0">
                <!-- （一）第三方监测平台车辆报警类型分析 -->
                ...
                <div v-for="row in listAlarmTypeAnalysis">
                    ...
                    <table class="img-table">
                        ...
                        <tbody>
                            <!-- <c:forEach items="${row.listAlarmTypeDetail}" var="item"> -->
            ...
            <div v-if="listAlarmStatistic.length > 0">
                <!-- （二）第三方监测平台车辆报警数据统计  -->
                ...
                <div v-for="row in listAlarmStatistic">
                    ...
                    <table class="img-table">
                        ...
                        <tbody>
                            <!-- <c:forEach items="${row.listAlarmStatisticDetail}" var="item"> -->
            ...
            <div v-if="listAlarmCountAnalysis.length > 0">
                <!-- （三）第三方监测平台车辆报警次数分析 -->
                ...
                <div v-for="row in listAlarmCountAnalysis">
                    ...
                    <table class="img-table">
                        ...
                        <tbody>
                            <!-- <c:forEach items="${row.listAlarmCountDetail}" var="item"> -->
            ...
            <div v-if="listAlarmAvgAnalysis.length > 0">
                <!-- （四）第三方监测平台车辆车均报警分析 -->
                <div class="info-title">{{ alarmAvgTitle }}</div>

                <div v-for="row in listAlarmAvgAnalysis">
                    <h3 class="info-h3">{{ row.title }}</h3>
                    <table class="img-table">
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            <!-- <c:forEach items="${row.listAlarmAvgDetail}" var="item"> -->
        ...
        <div class="fullpage">
            ...
            <div v-if="listCompanyAlarmRanking.length > 0">
                <!-- （一）企业监测报警均值排名 -->
                ...
                <div v-for="row in listCompanyAlarmRanking">
                    ...
                    <table class="img-table">
                        ...
                        <tbody>
                            <!-- <c:forEach items="${row.listRankingDetail}" var="item"> -->
            ...
            <div v-if="listAlarmCountRanking.length > 0">
                <!-- （二）车辆监测报警次数排名 -->
...
// import { download } from '@/api/statisticalStatement/briefingAnalysis/analysisBriefing';

const { title, row, data, download } = defineProps({
...
const { alarmAvgSummary, alarmAvgTitle, alarmCountAnalysisTitle, alarmCountSummary, alarmStatisticTitle, alarmTypeSummary, alarmTypeTitle, listAlarmAvgAnalysis, listAlarmCountAnalysis, listAlarmStatistic, listAlarmTypeAnalysis } = alarmAnalysis
