<template>
  <div>
    <!-- 封面页 -->
    <div class="fullpage">
      <div class="brief">{{ briefReportDto?.provinceName }}-{{ briefReportDto?.cityName }}简报&nbsp;&nbsp;
    ...
    <div class="fullpage">
      ...
      <!-- 表格1 -->
      <h3 style="margin-bottom: 10px; font-weight: 600 !important">{{ data?.areaName }}车辆总体情况</h3>
      ...
      <div>
        <!-- <c:if -->
        <div
          v-if="vehicleAlarmInfo?.importantVehicleAlarmInfo?.length > 0"
          ...
          <table class="img-table">
            ...
            <tbody>
              ...
              <tr v-for="item, index in vehicleAlarmInfo?.importantVehicleAlarmInfo">
                ...
                <!-- </c:if> -->
                <td v-if="index === vehicleAlarmInfo?.importantVehicleAlarmInfo?.length" colspan="2">{{ item?.areaName }}</td>
      ...
      <div>
        <!-- <c:if -->
        <div
          v-if="vehicleAlarmCountInfo?.importantVehicleAlarmCountInfo?.length > 0"
      ...
      <div>
        ...
        <div
          v-if="vehicleAvgAlarmInfo?.importantVehicleAvgAlarmInfo?.length > 0"
    ...
    <div class="fullpage">
      ...
      <div>
        ...
        <div
          v-if="companyAlarmInfo?.importantCompanyAlarmInfo?.length > 0"
      ...
      <div>
        ...
        <div
          v-if="vehicleAlarmDetailInfo?.importantVehicleAlarmInfo?.length > 0"
