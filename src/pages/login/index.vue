...
<!--                        <h1 class="login_title">兴山县兴发汽运有限公司</h1>-->
            ...
            <video
                ...
                loop
            >
                <source src="../../assets/video/loginbg.mp4" />
            </video>
        </div>
        <div class="login-container overflow relative">
            <div class="head">
                <img
                    @click="showAccoutCode = !showAccoutCode"
                    class="logo pointer"
            ...
            <div
                ...
                :style="`${
                    showAccoutCode ? 'transform: translateY(-100%);' : ''
            ...
            >
                ...
                <div class="bottomtext" style="padding-top: 325px">
                    浏览器推荐下载：谷歌 火狐 I V3.4.1.Beta
                </div>
            </div>
        </div>
...
const submitForm = async () => {
    ...
    loginForm.value.validate((valid: boolean) => {
        if (valid) {
            loading.value = true
            store.dispatch('user/login', ruleForm.value).then(async () => {
                login()
                loading.value = false
...
.login-body {
    ...
    .login_title { font-size: 34px;letter-spacing: 8px;color: #fff;}
    .videoContainer {
        position: fixed;
        width: 100%;
        height: 100%;
        ...
        .bjshadow {
            ...
            background: linear-gradient(
                180deg,
                rgba(84, 126, 232, 0.71) 0%,
                rgba(88, 157, 252, 0) 100%
            );
        }
    }
