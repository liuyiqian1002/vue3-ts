        ...
        <div class="table-wrapper">
          <div class="ctx" id="downloadContent">
            ...
            <div style="text-align: center;">
              ...
              <h2>鄂ATR876(黄色)预处罚通知单</h2>
            </div>
            <div class="title2" style="width: 50%">罚单编号：HBATR8762148</div>
            <table id="ctable" style="margin-top: 10px;" border="1">
              <tr>
                <td class="title" width="90">驾驶员</td>
                <td></td>
                <td class="title">所属机构</td>
                <td colspan="6">武汉东兴达客运有限公司</td>
              </tr>
              ...
              <tr>
                ...
                <td colspan="8">
                  合计：<br>
                  <div style="word-break: break-word;">{{dto?.dispoal?.preDisposalContent}}</div>
                </td>
              </tr>
              <tr>
                <td class="title">最终结论</td>
                <td colspan="8">{{dto?.dispoal?.preDisposalContent}}</td>
              </tr>
            </table>
            <div class="bot">
              <div style="width: 50%">
...
const onSubmit = () => {
  downLoadPdf(document.querySelector('#downloadContent'), '鄂ATR876(黄色)预处罚通知单')
}
defineExpose({ show })
</script>
