<template>
    <div>
        ...
        >
            ...
            <!-- <upload v-model="mainData.formData.fileList[0]" v-model:id="mainData.formData.fileIdList[0]" uploadTxt="照片附件"></upload> -->
        </tw-drawer>
    </div>
</template>
...
let mainData = reactive({
    formData: {
        ...
        publishObj: '',
        publishObject: [
            // {"businessName": "admin", "orgId": 100000000, "permissionLevel": 5}
        ],
    ...
    lists: [
        { key: 'title', label: '新闻标题：', placeholder: '请输入新闻标题' },
        {
            key: 'noticeType',
            label: '新闻类型：',
            type: 'select',
        ...
        },
        {
            ...
            change: (val, e) => {
                ...
                mainData.formData.publishObjectOrigin = []
                mainData.formData.publishObject = []
                if (val === '4') {
                    mainData.lists[3] = {
                        label: '',
