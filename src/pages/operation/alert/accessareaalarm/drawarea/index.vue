<template>
    <div>
        <tw-drawer @handleClose="handleClose" :loading="state.loading" :title="title" width="100%" :isBtns="false"
            v-model="state.drawerFlag">
            <div class="content-wrapper">
                <div class="left-wrapper">

                    <div>
                        <tw-custom-form class="w300 form-wrapper" ref="editFormRef" cancelBtn="取消" @colse="onClose"
...
const centerPoint = [114.30, 30.60]
...
let state = reactive({
    ...
    lists: [
        ...
        { label: '备注(选填)', key: 'remark', placeholder: '请输入备注' },
        { label: '开始时间', key: 'beginTime', type: 'date', data: { valueFormat: 'YYYY-MM-DD' }, placeholder: '请选择开始时间' },
        { label: '结束时间', key: 'endTime', type: 'date', data: { valueFormat: 'YYYY-MM-DD' }, placeholder: '请选择结束时间' },
    ],
    rules: {
        name: [
...
const onEditArea = () => {
    ...
    editor._polygonEditor.on("end", event => { // polyEditor  close关闭时执行
