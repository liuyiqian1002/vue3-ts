...
import { companyArchivesPage, CompanyArchivesQuery, getAttachListInfo } from '@/api/operation/filemanagement/enterprisefiles';
let title = $ref('')
...
let mainData = reactive({
    tableUrl: '/business/archives/companyArchivesPage',
    columns: [
