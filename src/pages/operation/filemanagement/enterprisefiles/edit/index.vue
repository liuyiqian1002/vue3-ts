        ...
        <div class="form-wrapper">
          <el-form class="demo-form-inline">
            ...
            <el-form-item label="档案类型:">
              <el-select v-model="form.archivesType" placeholder="请选择档案类型">
...
const { title, list, archiveTypes, archiveGategory } = defineProps({
  title: { type: String, default: () => '' },
  list: { type: Array<ListResItem>, default: () => [] },
  archiveTypes: { type: Array<{ label: string, value: number }>, default: () => [] },
