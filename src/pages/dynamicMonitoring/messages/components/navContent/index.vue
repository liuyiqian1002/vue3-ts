...
<!--            <div class="el-collapse-item is-active" :style="`height: ${collapseActiveName == '1'? 'calc(100% - 50px)':'50px'}`">-->
                <carList ref="carListRef" :formData="formData" @isCollapse="isCollapse" @checkNode="checkNode" @zoomAndCenterIns="zoomAndCenterIns" @closeCarDetails="closeCarDetails" @carDetails="carDetails" @nodeClick="nodeClick" @tapClick="tapClick" @carListVehicleCodeListUpate="(codes)=> carListVehicleCodeList = codes"></carList>
<!--            </div>-->
<!--            <div class="el-collapse-item h" :style="`height: ${collapseActiveName == '1'? 'calc(100% - 50px)':'130px'}`">-->
<!--                <onCar ref="onCarRef" :formData="formData" @carDetails="carDetails"  @nodeClick="nodeClick" @checkNode="checkNode" @tapClick="tapClick" @zoomAndCenterIns="zoomAndCenterIns" @addPageNumber="formData.pageNumber++" @onCarVehicleCodeListUpate="(codes)=> onCarVehicleCodeList = codes" :carListVehicleCodeList="carListVehicleCodeList"></onCar>-->
<!--            </div>-->
        </div>
    </div>
</template>
...
<style scoped lang="scss">
    #meaages_nav_content {
        ...
        .el-collapse-item__wrap { height: calc(100% - 100px);cursor: e-resize}
    }
</style>
