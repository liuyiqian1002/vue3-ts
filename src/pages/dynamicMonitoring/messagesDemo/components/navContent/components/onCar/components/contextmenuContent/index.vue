<template>
    <div class="fixed" style="left: 0; top: 0;right: 0;bottom: 0" v-show="showContextmenuContent" @click="showContextmenuContent = false">
...
.contextmenu{
    ...
    .contextmenu_li {
        line-height: 30px; margin: 5px 0;text-align: center;background: var(--el-bg-color);position: relative;z-index: 1;
