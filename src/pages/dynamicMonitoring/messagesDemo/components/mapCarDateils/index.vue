<template>
    <div>
        <div class="absolute" :style="`top:50px; left: 50%; transform: translateX(calc(-50% + 170px));`">
                    ...
                    <div style="height: 318px;overflow: hidden">
                        <el-tabs v-model="activeName"  class="demo-tabs" @tab-click="handleClick">
                            ...
                            <el-tab-pane label="车辆信息" name="second" lazy>
                                ...
                                <el-button class="fr" type="primary" text @click="viewCar">查看详情</el-button>
                            </el-tab-pane>
...
<!--                                <el-button class="fr" type="primary" text @click="viewInsurance">查看详情</el-button>-->
        ...
        <!--  人员  -->
        <user ref="userRef" title="人员信息"></user>
        <!--  车辆  -->
        <car ref="carRef" title="车辆信息"></car>
        <!--  保险  -->
        <insurance ref="insuranceRef" title="保险信息"></insurance>
    </div>
...
let mainData = reactive({
    ...
    userHeadBtns: {
        prop: "btns", label: "操作", fixed: "right", width: 40, btns: [
            {
    ...
    btns: [
        { name: '视频', icon: 'chakanshipin', click: 'sendVideo'},
        { name: '发送语音', icon: 'fasongyuyin', click: 'sendVoice'},
        { name: '拍照', icon: 'fasongzhaopian', click: 'sendPhoto'},
